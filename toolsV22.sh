...
echo $red"            harap sabar menunggu boy :v("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  Faqih  "$i"                  "
echo $i""$pu"  Recode?   :  Boleh asal cantumin sumbernya Yt:Dunia Script"$i"              "
echo $i""$pu"  YOUTUBE   :  YouTube Dunia Script"$i"               "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Author   :"$i" Faqih"
echo $ku"YouTube  :"$i" YouTube Dunia Script"
echo $ku"Facebook :"$i" Faqih ID"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE Dunia Script }"
exit
fi
